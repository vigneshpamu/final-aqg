...
if(isset($_POST['submit']))
{
	...
	$sql = "INSERT INTO fill_in_the_blank_based_question (stream_id, department_id, degree_id, class_id, subject_id, unit_id, question, answer) VALUES ('$stream_id', '$departments_id', '$degree_id', '$class_id', '$subject_id', '$unit_id', '$question', '$answer')";
	$stmt = $db->prepare($sql);
	if($stmt->execute())
	{
...
<div>
	...
	<div class="row">
		<div class="col-sm-12">
				...
				<h3 class="heading-name">Add Fill In The Blank Type Questions</h3>
				<div class="div-form">
					<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
						...
						<input type="text" class="input-text" id="question" name="question" placeholder="ex.(__________is a prime _________ of india.)" required>
						
						
						<label for="answer">Answer</label>
						<input type="text" class="input-text" id="answer" name="answer" placeholder="ex.(Narendra modi, Prime)" required>
