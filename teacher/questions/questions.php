...
<div>
	...
	<div class="row">
		<div class="col-sm-12">
			...
			<a href="/teacher/questions/small_question/mcq_based_question.php"><button class="input-submit" id="mcq" name="mcq">MCQ Based Question</button></a>
			<a href="/teacher/questions/small_question/fill_in_the_blank_based_question.php"><button class="input-submit" id="fill_in_the_blanks" name="fill_in_the_blanks">Fill in the Blank Type Question</button></a>
			<a href="/teacher/questions/small_question/one_marks_question.php"><button class="input-submit" id="one_marks_question" name="one_marks_question">One Marks Question</button></a>
			...
			<a href="/teacher/questions/big_question/four_marks_question.php"><button class="input-submit" id="four_marks_question" name="four_marks_question">Four Marks Question</button>
			<a href="/teacher/questions/big_question/five_marks_question.php"><button class="input-submit" id="five_marks_question" name="four_marks_question">Five Marks Question</button>
		</div>
	</div>
</div>
