...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO five_marks_question (stream_id, department_id, degree_id, class_id, subject_id, unit_id, question, answer) VALUES ('$stream_id', '$departments_id', '$degree_id', '$class_id', '$subject_id', '$unit_id', '$question', '$answer')";
    $stmt = $db->prepare($sql);
    if ($stmt->execute()) {
...
<div>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <h3 class="heading-name">Add Five Marks Questions</h3>
            <div class="div-form">
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                    ...
                    <textarea type="text" style="resize:none;" rows="6" class="input-text" id="answer" name="answer"
                              placeholder="ex.(Write a paragraph.)" required></textarea>
