...
if (isset($_POST['edit'])) {
    ...
    // Prepare the SQL query for editing
        ...
        <div class="col-sm-12">
            ...
            <div class="div-form">
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
                    ...
                    <input type="text" class="input-text" id="mcq_question" name="mcq_question" placeholder="ex. how many numbers use in binary ?." required>
