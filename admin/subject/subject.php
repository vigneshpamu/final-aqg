...
if(isset($_POST['submit']))
{
	...
	$sql = "INSERT INTO subjects (stream_id, departments_id, degree_id, class_id, subject_name) VALUES ('$stream_id', '$departments_id', '$degree_id', '$class_id', '$subject_name')";
	$stmt = $db->prepare($sql);
...
if(isset($_POST['edit']))
{
	...
	$class_id = trim($_POST['class_id']);
	$subject_name = trim($_POST['subject_name']);
	$sql = "UPDATE subjects SET stream_id = '$stream_id', departments_id = '$departments_id', degree_id='$degree_id', class_id='$class_id', subject_name='$subject_name' WHERE id = '$id'";
	$stmt = $db->prepare($sql);
	if($stmt->execute())
	{
